...
public class Scorer {
    public static final long TIME_CAP_MILLIS = 5000;
...
//        );
    ...
    public void run() {
        ...
        while (System.currentTimeMillis() - startTime < TIME_CAP_MILLIS) {
//            System.out.format("Depth: %d\n", depth);
            ...
            if (System.currentTimeMillis() - startTime >= TIME_CAP_MILLIS) {
                return;
            }

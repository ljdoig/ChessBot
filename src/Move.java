...
public class Move implements Comparable<Move> {
    ...
    public String toString() {
        return piece + ": " + from + " -> " + to
                + scoreString()
                + (taken != null ? " t: " + taken.getClass().getName() : "");
    }
    ...
    // For humans
    public static Move getClickedMove(Piece piece, Square to, Input input) {
    ...
    private void calculateHeuristic() {
        ...
        if (board.pawnAttackedSquares().contains(to)) {

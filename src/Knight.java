...
public class Knight extends Piece {
    private static final Image blackImage = new Image("res/pieces/black/knight.png");
    private static final Image whiteImage = new Image("res/pieces/white/knight.png");
